...
`grok/integrity-distribution-convergence-20260820`. Do not use `@main`.
...
full workflow. The installable skill is a separate agent-discovery surface;
it does not replace this SHA pin.
